...
export const Post = ({user, post, click}) => {
    return (
        <div className='post'>
            <div className='post__header'>
               <div className='post__user' onClick={click}>
                    <figure>
            ...
            <article className='post__article'>
                <h4>666 Me gustas</h4>
                <p><strong> {user} </strong>Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit. Exercitation veniam consequat sunt nostrud amet.</p>
